...
if (!data.storageExists) {
  ...
  library.users.members.push(
    new Member(
      9000,
      "Drew Borrowmore",
      42,
      "123, Any Street, Anytown, RE12AD",
      "01256445556",
      "some@email.com"
    ),
    new Member(
      ...
      "Toby Lenderson",
      45,
      "456, Some Street, Sometown, BO010KS",
      "01256541236",
      "some@email.com"
    ),
    new Member(
    ...
    new Member(
      ...
      "Dwrite Shrute",
      34,
      "1, Schrute Farm, Sometown, BE333TS",
      "01256541432",
      "some@email.com"
    )
  );
